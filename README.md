...
I like building web apps, small tools, and occasionally experimenting with app development. These days I'm working with TypeScript + React, Python + Django, and Dart + Flutter.

I also have a habit of starting side projects faster than I finish them.
...
Google Docs Apps Script for translating documents in a side-by-side view, built with legal documents in mind.

[Repository](https://github.com/Vlad-GitH/side-by-side-translate)
...
Small Python/OpenCV CLI tools for extracting specific UI assets from screenshots.

[Repository](https://github.com/Vlad-GitH/WWM_Croppers)
